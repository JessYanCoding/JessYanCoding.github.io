...
所有的全局配置选项在 [Demo](https://github.com/JessYanCoding/AndroidAutoSize/blob/master/demo/src/main/java/me/jessyan/autosize/demo/BaseApplication.java#L55) 中都有介绍，每个 **API** 中也都有详细的注释，在这里就不过多介绍了
